...
@SmallTest
public class RecipeIngredientRepositoryTest extends TestCase {
    ...
    @Before
    public void setUp() {
        recipeIngredientRepository = RecipeIngredientRepository.getInstance(ApplicationProvider.getApplicationContext());
