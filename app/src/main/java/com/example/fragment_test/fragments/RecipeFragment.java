...
import com.example.fragment_test.adapter.RecipeDaysAdapter;
...
public class RecipeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView eachDayListView = view.findViewById(R.id.eachDay);
        eachDayListView.setAdapter(new RecipeDaysAdapter(inflater,recipes));
